...
// memilih elemen textarea
const inputDeskripsi = document.querySelector('#description');
const deskripsiPratinjau = document.querySelector('#preview-desc');

const inputResepKategory = document.querySelector('#recipe-kategory');
const ResepKategoryPratinjau = document.querySelector('#preview-kategory');
...
inputResepKategory.addEventListener('input', function() {
    const inputResep = inputResepKategory.value;
    
    if (inputResep === "") {
        ResepKategoryPratinjau.textContent = "Deskripsi resep Anda akan muncul di sini...";
    } else {
        ResepKategoryPratinjau.textContent = inputResep;
    }
});
...
const kesulitanText1 = document.querySelector('#preview-difficulty-text1');
...
inputKesulitan.addEventListener('input', function() {
    ...
    kesulitanText1.textContent = textKesulitan;
});
